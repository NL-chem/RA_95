...
read -p "do you want the possibility to open the best scoring structures in pymol? " open
#copy 10 best structures
if [[ $open =~ ^[Yy]$ ]]
then
	read -p "do you want to copy the best 10 pdb files you opened in pymol for later easy access? " copy
fi
				...
				then
					...
					for loop_over_files in $best_10_pdb;do
						...
						then
							...
							cp $old_file_name $new_dir/$new_file_name
